...
def deterministic_hash_backend(monkeypatch):
    """Property tests exercise the documented hash fallback, never Hub I/O."""

    def disable_clip(instance):
        instance._clip_model = None
        instance._clip_processor = None
        instance._clip_available = False

    async def run_inline(func, *args, **kwargs):
        return func(*args, **kwargs)

    monkeypatch.setattr(TokenCompressorStrategy, "_load_clip_model", disable_clip)
