...
Guidance for Codex when working in this repo. Keep terse — see rule "Trim AGENTS.md" below.
...
4. **Trim this file periodically. Cap ~300 lines.**
   - Before editing AGENTS.md, run `wc -l AGENTS.md`. If it's over ~300 (or the delta would push it over), first prune before adding.
